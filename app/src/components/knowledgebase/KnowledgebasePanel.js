  ...
  return (
    <div className="kb-panel">
      ...
      <div className="kb-tabs">
        ...
        >
          📄 Documents
          <span className="kb-tab__count">{docs.length}</span>
        </button>
        <button
          type="button"
          className={`kb-tab ${activeTab === "repositories" ? "kb-tab--active" : ""}`}
      ...
      {/* Documents Tab */}
      {activeTab === "documents" && (
        <div className="kb-tab-body kb-docs-layout">
          {/* Left: Document List */}
          <div className="kb-docs-left">
            <h4 className="kb-docs-left__title">
              Uploaded Documents
              <span className="kb-muted">({docs.length})</span>
            </h4>
