const RULE_PACKS = {
  ...
  pm: {
    ...
    delegationRules: [
      ...
      "These tools route work to specialized agents for document and presentation generation.",
      "",
      "=== WHEN TO USE delegate_to_document_agent ===",
      "Use when user explicitly asks for document creation:",
      "- 'Create a document from this', 'Generate a document', 'Make a document'",
      "- 'Export this report to a document', 'Prepare a document'",
      "- 'Create a formal document', 'Export the report summary into a document'",
      "",
      "WORKFLOW:",
      "1. Gather all needed data using your analytics/report tools first",
      "2. Pass the complete content to delegate_to_document_agent",
      "3. The Document Agent will create a professionally formatted document asynchronously",
      "4. Inform user the document is being generated and will appear in Documents tab",
      "",
      "NOTE: For quick PDF download of report content already shown in chat, users can use the Download PDF button that appears on report messages in the UI.",
      "",
      "=== WHEN TO USE delegate_to_presentation_agent ===",
      "Use when user explicitly asks for presentation/slides:",
      "- 'Create a presentation', 'Generate slides', 'Make a PPT'",
      "- 'Create a PowerPoint', 'Prepare slides', 'Turn this into slides'",
      "",
      "WORKFLOW:",
      "1. Gather all needed data first",
      "2. Pass the complete content to delegate_to_presentation_agent",
      "3. Inform user the presentation is being generated",
    ],
